...
<head>
    <link rel="icon" href="img/My project5.png" type="image/gif">
    <title>New Order-ProtX</title>
    ...
    <div class="w3-black">
            ...
            <nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
                ...
                <a href="ORDER.php" class="w3-bar-item w3-button w3-padding-large w3-black">
                    <div class="notification">
                        <img src="img/My project.png" width="120%">
                        <?php
                        if ($count > 0) {
                        ?>
                            <span class="badge"><?php echo $count; ?></span><?php } ?><br>
                        <p><b>New</b></p>
                    </div>
                </a>
                <a href="Add car.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
                    <div class="notification">
        ...
        <div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
            <div class="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
                <a href="Main.php" class="w3-bar-item w3-button" style="width:25% !important"><b>Home</b></a>
        ...
        <div class="container bootstrap snippet">
            ...
            <div class="row">
                ...
                <div class="w3-padding-64 w3-content w3-text-black" id="info">
                    ...
                    <br>
                    <center> <a href="Uprofile.php"><button type="button" class="btn btn-secondary"><i class="fa fa-check-circle fa-3x"></i><br>Confirm</button></a></center>
